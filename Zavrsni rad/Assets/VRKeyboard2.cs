...
namespace BNG {
    public class VRKeyboard2 : MonoBehaviour {
        ...
        public void AttachToInputField(Transform inputBox) {
            TMP_InputField inputField = inputBox.GetComponent<TMP_InputField>();
            AttachedInputField = inputField;
        }

        public void DeselectInputField() {
            AttachedInputField = null;
        }
    }
}